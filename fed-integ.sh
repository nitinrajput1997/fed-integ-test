...
help()
{
   ...
   echo
   echo "Syntax: scriptTemplate [1st argu|2nd argu]"
   echo "options:"
   echo "first argument    Give the Link of the repo you want to clone."
   echo "second argument    Give the Branch Name on which you want to work."
   echo
}
